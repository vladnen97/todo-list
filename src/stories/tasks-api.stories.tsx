...
const GetC = () => {
    ...
    const onClickHandler = () => {
        tasksAPI.getTasks(todolistId).then(res => setState(res.data.items.map(el => `${el.title} : ${el.id} : ${el.status}`)))
        setTodolistId('')
    }
    ...
    return (
        <>
            ...
            <input value={todolistId} placeholder={'enter todolist id '}
    ...
    return (
        <>
            <input placeholder={'enter todolist id'} value={todolistId}
                   onChange={e => setTodolistId(e.currentTarget.value)} required/>
            <input placeholder={'enter task title'} value={title} onChange={e => setTitle(e.currentTarget.value)}
                   required/>
...
const DeleteC = () => {
    ...
    return (
        <>
            <input value={todoId} onChange={e => setTodoId(e.currentTarget.value)} placeholder={'enter todolist id '}/>
...
const UpdateC = () => {
    ...
    return (
        <>
            <div>
                <input value={todoId} onChange={e => setTodoId(e.currentTarget.value)}
