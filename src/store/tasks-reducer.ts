...
//thunks
const fetchTasks = createAppAsyncThunk<{ tasks: Array<TaskResponseType>, todolistId: string }, string>('tasks/fetchTasks', async (todolistId, thunkAPI) => {
